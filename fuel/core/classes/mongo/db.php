...
class Mongo_Db
{
	...
	protected function _where_init($param)
	{
        ...
        //add
        public function get_view_datas($instance = null, $collection_name = null, $id = null) {
//            is_null($instance) and Response::redirect('Blog');
            $res = $instance->get_where($collection_name, array('id' => $id));
            return (Object)$res[0];
        }
}
